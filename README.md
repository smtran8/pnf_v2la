...
- Update: Tried YOLO26 by Ultralytics: [https://docs.ultralytics.com/tasks/detect#export](Reference). The model cannot detect a LIMO => Start gathering data and will fine-tune model
